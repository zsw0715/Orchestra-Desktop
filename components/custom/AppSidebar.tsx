...
export default function AppSidebar() {
    ...
    return (
        <div
            className={cn(
                "relative h-full shrink-0 flex flex-col rounded-l-[12px] rounded-r-[12px] transition-all duration-350 origin-left",
        ...
        >
            ...
            {/* 关闭侧边栏按钮 */}
            <div className="absolute right-2 top-2 p-1.5 rounded-md hover:bg-white/10 cursor-pointer transition-all duration-350" onClick={() => setIsSidebarOpen(false)}>
